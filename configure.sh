...
echo "#############################"
# delete any files called google-chrome-stable_current_amd64.deb*
...
echo "Running..."
echo "#############################"
docker run --rm --restart=always --log-opt max-size=10m --name grass -v "$parentDir":/app grass_image
